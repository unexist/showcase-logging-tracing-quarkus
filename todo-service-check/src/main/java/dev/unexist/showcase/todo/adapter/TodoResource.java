...
public class TodoResource {
    ...
    @Inject
    @Channel("todo-generator")
    Emitter<String> todoGenerator;
    ...
    public Response createDirect(TodoBase base, @Context UriInfo uriInfo) {
    ...
    public Response createIndirect(TodoBase base, @Context UriInfo uriInfo) {
        Response.ResponseBuilder response;

        try {
            String json = this.mapper.writeValueAsString(base);

            this.todoGenerator.send(json);
